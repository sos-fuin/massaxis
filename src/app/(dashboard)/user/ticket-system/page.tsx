        ...
        <div className="my-5">
          <DBCard>
            <div className="p-[30px]">
              <div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-skin-color-3 font-semibold  text-xs flex items-center gap-3 flex-wrap">
              ...
              <div className="p-2 sm:p-5 bg-skin-color-3 rounded-xl mt-5 border border-gray-300">
                <div className="flex items-center gap-4">
                  <div>
                    <Image
                      alt="user"
